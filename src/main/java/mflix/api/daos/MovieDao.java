...
public class MovieDao extends AbstractMFlixDao {
    ...
    public List<Document> getMoviesByCountry(String... country) {
        ...
        //TODO> Ticket2: Projection - implement the query and projection required by the unit test
        List<Document> movies = new ArrayList<>();
        moviesCollection
                .find(queryFilter)
    ...
    public List<Document> getMoviesByCast(String sortKey, int limit, int skip, String... cast) {
        ...
        Bson sort = null;
        //TODO> Ticket3: Subfield Text Search - implement the expected cast
        // filter and sort
    ...
    public List<Document> getMoviesByGenre(String sortKey, int limit, int skip, String... genres) {
        ...
        List<Document> movies = new ArrayList<>();
        // TODO > Ticket5: Paging - implement the necessary cursor methods to support simple
    ...
    public List<Document> getMoviesCastFaceted(int limit, int skip, String... cast) {
        ...
        // TODO > Ticket4: Faceted Search - build the aggregation pipeline by adding all stages in the
        // correct order
